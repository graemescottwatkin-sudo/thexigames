...
/* Through text.js: the block below is lifted out by anchors written with
   \n, and a Windows checkout of the hub is CRLF. Read raw, the anchor never
   matched there and nine assertions failed on a tree CI was green on
   (24 Sep 2026). */
...
console.log("\nThe hub reads whichever branch it is on");
{
  ...
  const hub = readText(themeHubFile("football"));
