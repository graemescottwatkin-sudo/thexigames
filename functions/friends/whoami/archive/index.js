/* /friends/whoami/archive/ — every board this game has had, at its own address.
   See functions/_lib/archive-page.js, which holds the page for every game; this
   file is the route and nothing else, so twelve games cannot grow twelve
   archives.
...
export const onRequestGet = (ctx) => archiveRoute(ctx, "whoami_fr");
